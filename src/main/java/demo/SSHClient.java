...
public class SSHClient {
	...
	private static final long defaultTimeOut = 1000;//时间长了的话grep不到日志，短了的话，超时退出，不设超时的话，一直执行第一个操作。。貌似命令没有退出标识。
	//为什么正则匹配的这些规则没有匹配到服务器反悔呢
	...
	public SSHClient(String ip, int port, String user, String password) {
		this.ip = ip;
		this.port = port;
		this.user = user;
